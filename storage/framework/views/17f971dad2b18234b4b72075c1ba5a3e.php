                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?php echo e(route('jabatan.edit', $jbt->id)); ?>"><i
                                                            class="fe fe-edit fe-16"></i>&nbsp;Edit</a>
                                                    <form method="POST" action="<?php echo e(route('jabatan.destroy', $jbt->id)); ?>">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kepegawaian-crud-spatie2\resources\views/admin/master/jabatan/index.blade.php ENDPATH**/ ?>